...
output:
  BiocStyle::html_document:
    ...
    toc_depth: 2
vignette: >
  % \VignetteIndexEntry{A.4 -- Statistics}
...
<!--
```{r echo=FALSE}
path <- system.file(package="RIntro.RPCI.Jan2017", "extdata",
    "BRFSS-subset.csv")
```
-->
...
_R_ read `Year` is an integer value, but it's really a `factor`

```{r}
brfss$Year <- factor(brfss$Year)
```

## Weight in 1990 vs. 2010 Feamles
