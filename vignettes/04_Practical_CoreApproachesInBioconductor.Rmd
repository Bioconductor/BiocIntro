...
1. Use base _R_ `read.csv()` to import the sample sheet and read
   counts. Use the argument `row.names=` to specific the `Run` column
...
2. Assemble `SummarizedExperiment` from transposed `counts` and `pdata`
