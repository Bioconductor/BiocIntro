---
title: "_Bioconductor_ for Everyone"
author:
- name: Martin Morgan
...
# _R_ / _Bioconductor_ for Everyone
...
`r knitr::include_graphics(system.file(package='BiocIntro', 'vignettes', 'RStudio.png'))`
...
```{r, echo = FALSE}
fname <- system.file(package="BiocIntro", "vignettes", "ALL-phenoData.csv")
```
...
```{r, echo = FALSE}
fname <- system.file(
    package = "BiocIntro", "vignettes", "CpGislands.Hsapiens.hg38.UCSC.bed"
)
```
...
`r knitr::include_graphics(system.file(package='BiocIntro', 'vignettes', 'SummarizedExperiment.png'))`
...
```{r, echo=FALSE}
fname <- system.file(package = "BiocIntro", "vignettes", "airway_colData.csv")
```
...
```{r, echo=FALSE}
fname <- system.file(package="BiocIntro", "vignettes", "airway_counts.csv")
```
